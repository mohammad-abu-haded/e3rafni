        ...
        <table width="480" cellpadding="0" cellspacing="0" border="0"
          ...
          <tr>
            <td style="padding:32px 36px 28px;">
              <p style="
                margin:0 0 6px;font-size:22px;font-weight:700;color:#09090b;line-height:1.35;
                font-family:'Tahoma','Segoe UI',-apple-system,BlinkMacSystemFont,Arial,sans-serif;
              ">تحقق من هويتك</p>
              <p style="
                margin:0 0 28px;font-size:14px;color:#71717a;line-height:1.8;
                font-family:'Tahoma','Segoe UI',-apple-system,BlinkMacSystemFont,Arial,sans-serif;
              ">
              ...
              ">
                <tr>
                  <td style="padding:12px 16px;">
                    ...
                    ">لم تطلب هذا؟</p>
                    <p style="
                      margin:0;font-size:12px;color:#71717a;line-height:1.75;
                      font-family:'Tahoma','Segoe UI',-apple-system,BlinkMacSystemFont,Arial,sans-serif;
                    ">
