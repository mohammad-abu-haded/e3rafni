...
CREATE TABLE `RoomMembers` (
    ...
    UNIQUE INDEX `RoomMembers_userId_key`(`userId`),
...
-- AddForeignKey
ALTER TABLE `RoundMembers` ADD CONSTRAINT `RoundMembers_roundId_fkey` FOREIGN KEY (`roundId`) REFERENCES `Rounds`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
